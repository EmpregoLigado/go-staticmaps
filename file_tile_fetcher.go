...
func (t *FileTileFetcher) url(zoom, x, y int) string {
	shard := ""
...
func (t *FileTileFetcher) cacheFileName(cache TileCache, zoom int, x, y int) string {
...
func (t *FileTileFetcher) download(url string) ([]byte, error) {
...
func (t *FileTileFetcher) loadCache(fileName string) (image.Image, error) {
...
func (t *FileTileFetcher) createCacheDir(path string) error {
...
func (t *FileTileFetcher) storeCache(fileName string, data []byte) error {
